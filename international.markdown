...
*Above: Risk of elderly pedestrian fatality calculated using logistic regression from Ashton and Mackay data compared with the Davis function. Source: Figure 2.4 from “Relationship between Speed and Risk of Fatal Injury: Pedestrians and Car Occupants” (D. C. Richards. 2010, p13).*
{: style="font-size: 80%" }
